...
function formatDate(val,row,index){
	if(val != null && val != undefined){
		var date = new Date(parseInt(val.time, 10));
		var month = date.getMonth() + 1 < 10 ? "0" + (date.getMonth() + 1) : date.getMonth() + 1;
		var currentDate = date.getDate() < 10 ? "0" + date.getDate() : date.getDate();
		var hour = val.hours < 10 ? "0"+val.hours:val.hours;
		var minutes = val.minutes < 10 ? "0"+val.minutes: val.minutes;
		var seconds = val.seconds < 10 ? "0"+val.seconds: val.seconds;
