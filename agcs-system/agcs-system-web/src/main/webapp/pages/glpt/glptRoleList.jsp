...
<script type="text/javascript">
	$(document).ready(function(){
		$('#dgGlptRole').datagrid({   
            ...
            border: true,
            fit: true,//自动大小
            url:'glptRoleController.do?datagridPage',
            loadMsg : '数据装载中......',  
		...
		//设置分页控件 
	    var p = $('#dgGlptRole').datagrid('getPager'); 
	    $(p).pagination({   
	...
	function QueryData() {
		var queryParams = $('#dgGlptRole').datagrid('options').queryParams; 
	    $("#dgGlptRole").datagrid('load');
	}
...
<body>
	<table id="dgGlptRole" class="easyui-datagrid" title="角色信息">
		<thead>
			<tr>
				...
				<th data-options="field:'roleName', sortable:true" width="100"><label class="lab1">角色名称</label></th>
				<th data-options="field:'state', sortable:true" width="100"><label class="lab1">状态(有效1、无效0)</label></th>
	...
	<div id="tb" style="display: none;">
		...
		<div style="padding-bottom: 5px; padding-left: 10px;">
			<div style="padding-bottom: 5px; padding-left: 10px;">
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'" onclick="add('录入','icon-add', 700, 400, 'glptRoleController.do?saveorupdate')">新&nbsp;增&nbsp;</a>
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-edit'" onclick="update('编辑','icon-add', 700, 400, 'glptRoleController.do?saveorupdate', 'dgGlptRole')">编&nbsp;辑&nbsp;</a>
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-search'" onclick="detail('查看','icon-add', 700, 400, 'glptRoleController.do?saveorupdate', 'dgGlptRole')">查&nbsp;看&nbsp;</a>
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-remove'" onclick="del('glptRoleController.do?delete', 'dgGlptRole')">删&nbsp;除&nbsp;</a>
		</div>
		</div>
	</div>
</body>
