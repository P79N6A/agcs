package org.agcs.system.cache.redis;
...
import org.agcs.system.core.util.SerializeUtil;
...
public class RedisClientTemplate {
    ...
    public String set(String key, Object obj){
    	return set(key.getBytes(), SerializeUtil.serialize(obj));
    }
