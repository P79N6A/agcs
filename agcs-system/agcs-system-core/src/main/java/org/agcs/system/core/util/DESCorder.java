...
//		System.out.println("【解密后】：" + myMsgArr);
		...
		String md5 = DESCorder.encodeMD5("wangyong123456");
		System.out.println(md5);
		
		System.out.println("【密钥】："+DESCorder.initKeyString("RE9JRE9aSFVCSWRzZmZkc2Zkc3NkZlpJ"));
		String secretArr = DESCorder.encryptModeToString("fsdfdsfeeghgfdfsdgfsdfdsjhdsg+20165847436", "RE9JRE9aSFVCSWRzZmZkc2Zkc3NkZlpJ");
		System.out.println("【加密后】：" + secretArr);
		
		String myMsgArr = DESCorder.decryptMode(secretArr, "RE9JRE9aSFVCSWRzZmZkc2Zkc3NkZlpJ", "gbk");
		System.out.println("【解密后】：" + myMsgArr);
		
		System.out.println("402880c85498564e0154985821980000".substring(0,31));
	}
