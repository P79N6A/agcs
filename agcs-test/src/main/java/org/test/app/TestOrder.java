...
import org.test.app.thread.OrdersRunner;
...
//		for(int i = 0; i < 1; i++){
//			OrdersRunner orderRunner = new OrdersRunner();
//			orderRunner.setPhone("18319042381");
//			orderRunner.setPassword("11111111");
//			Thread thread = new Thread(orderRunner, "Thread-"+i);
//			thread.start();
//			try {
//				Thread.sleep(100);
//			} catch (Exception e) {
...
//			}
//		}
		System.out.println("18319042381：123".replace("：", ":"));
		System.out.println(StringUtil.decode("第三方"));
